...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingImageView = findViewById(R.id.collapsing_image_view);
        ...
        intentFilter.addAction(UpdaterService.NO_CONNECTIVITY);
    ...
    private BroadcastReceiver mRefreshingReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (UpdaterService.BROADCAST_ACTION_STATE_CHANGE.equals(intent.getAction())) {
                ...
                updateRefreshingUI();
            } else if (UpdaterService.NO_CONNECTIVITY.equals(intent.getAction())) {
                mSwipeRefreshLayout.setRefreshing(false);
                Snackbar.make(findViewById(android.R.id.content), R.string.please_connect_to_wifi, Snackbar.LENGTH_LONG).show();
            }
        }
    };
        ...
        public ViewHolder onCreateViewHolder(@NonNull final ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(baseContext);
